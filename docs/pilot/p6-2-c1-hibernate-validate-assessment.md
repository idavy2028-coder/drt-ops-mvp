...
> 后续状态（2026-09-12）：用户已要求先完成本修复再讨论媒体启动。六个 CHAR 映射已修复，隔离 PG 上完整 31 实体 validate 通过；PG 18/18、本地相关回归 151/151。详见[实施与验证报告](evidence/p6-2/c1-hibernate-validate-fix-2026-09-12.md)。以下保留为实施前评估，不能用其中“尚未修复”的历史描述覆盖本结果。
