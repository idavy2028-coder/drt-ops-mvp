...
export function updateUserDisplayName(userId: string, displayName: string): Promise<UserAccount> { return request(`/api/users/${userId}/profile`, { method: "PUT", body: JSON.stringify({ displayName }) }); }
