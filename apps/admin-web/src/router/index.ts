...
import OnboardSystemManagementPage from "../pages/OnboardSystemManagementPage.vue";
...
export const routes: RouteRecordRaw[] = [
  ...
  { path: "/orders", name: "orders", component: OrdersPage, meta: { title: "订单中心", permission: "ORDER_READ", keepAlive: true } },
  { path: "/tasks", name: "tasks", component: TasksPage, meta: { title: "车辆任务", permission: "TASK_READ", keepAlive: true } },
  ...
  { path: "/terminals", name: "terminals", component: OnboardSystemManagementPage, meta: { title: "车载系统", permission: "TERMINAL_READ" } },
  { path: "/terminals/devices", name: "terminalDevices", component: TerminalManagementPage, meta: { title: "物理设备", permission: "TERMINAL_READ" } },
