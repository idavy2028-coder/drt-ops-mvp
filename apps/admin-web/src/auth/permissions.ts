...
const permissionsByRole: Record<string, readonly PermissionCode[]> = {
  SYSTEM_ADMIN: ["USER_MANAGE", "RULE_MANAGE", "RESOURCE_MANAGE", "ORDER_READ", "TASK_READ", "AUDIT_READ", "METRICS_READ", "DECISION_READ"],
  DISPATCHER: ["ORDER_READ", "DISPATCH_EXECUTE", "MANUAL_REVIEW", "TASK_READ", "TASK_EXECUTE", "DECISION_READ"],
